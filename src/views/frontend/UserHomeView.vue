...
<template>
  <div>
    <div class="position-relative">
      <h6 class="bg-warning-subtle p-1 m-0 text-center text-danger">
        目前訂閱電子報，即送9折優惠劵!
      </h6>
    ...
    <div class="container">
      ...
      <div class="row justify-content-md-center align-items-center mb-4 my-lg-5"
        ...
        <div class="col-md-6 text-center text-md-start">
          <h3 class="d-inline-block border-bottom border-secondary border-3">{{ item.title }}</h3>
    ...
    <div class="p-4 bg-body sea-border">
      <div class="container">
        <div class="row justify-content-center my-5 gy-4">
          ...
          <div class="col-lg-7 bg-body rounded-4 border border-3 border-Secondary p-4 bg-opacity-75">
