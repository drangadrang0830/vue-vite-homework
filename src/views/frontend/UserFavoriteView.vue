...
<template>
  <div class="py-4">
    <div class="container">
      <h3 class="text-center fw-bold">我的最愛</h3>
      <hr />
    </div>
    <div class="container my-4">
      <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 gx-3 gy-4" v-if="userFavoriteStore.favorites?.length > 0">
        <div class="col-12" v-for="product in userFavoriteStore.favorites" :key="product.id">
          <div class="card h-100 position-relative overflow-hidden" @click.prevent="getProduct(product.id)">
            ...
            <div class="card-badgeImgWarp position-absolute z-2 p-2"
              ...
              <i :class="userFavoriteStore.isFavorite(product.id)
            ...
            <div class="card-footer p-0">
              <button class="btn btn-info btn-sm rounded-top-0 w-100 py-2" type="button"
