...
import useAdminOrderStore from '@/stores/backend/adminOrderStore'
              ...
              <div class="d-flex align-items-center justify-content-between border-top pt-3">
                ...
                <div class="btn-group">
                  <button class="btn btn-sm btn-outline-primary" type="button"
                    @click="openOrderDetailModal(order)">檢視</button>
                  <button class="btn btn-sm btn-outline-danger" type="button"
                    @click="openDeleteOrder(order)">刪除</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <td class="text-center">
            <div class="btn-group">
              <button class="btn btn-outline-primary btn-sm" type="button"
                @click="openOrderDetailModal(order)">檢視</button>
              <button class="btn btn-outline-danger btn-sm" type="button" @click="openDeleteOrder(order)">刪除</button>
            </div>
          </td>
        </tr>
      </tbody>
